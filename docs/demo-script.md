...
The API listens on `http://127.0.0.1:8080` (loopback only). The default LLM
...
| Port 8080 already in use | Start with `--server.port=8091` and set the Vite proxy target accordingly |
